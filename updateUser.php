                               ...
                               <?php   if (!isset ($_POST['idUser']) ||($_POST['idUser'] != 'IDUSER')) {
                                 ?>
                                         <div class="col-md-4 col-md-offset-2" style="margin-top: 40px;">
                                          <form method="post" action="updateUser.php" role="form" data-toggle="validator">
                                ...
                                <?php
                                     ...
                                     if(  findUser($_POST['idUs'])  ){ 
                                       
                                        header ("Location: updateUser2.php");
                                       }else{
                                    ?>  
                                    <div class="col-md-6 col-md-offset-2" style="margin-top: 40px;">
                                      <h3>User not foud, try with another id</h3>
                                        <form action="updateUser.php"</form>
