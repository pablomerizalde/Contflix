            ...
            <div class="col-md-10 col-md-offset-1" style="margin-top: -20px;">
                  ...
                  <div class="jumbotron">
                        ...
                        <ul class="nav nav-tabs">
                              ...
                              <li role="presentation" class="active"><a href="registerUser.php">Create</a></li>
                              ...
                              <?php 
                                   if (!isset ($_POST['register']) ||($_POST['register'] != 'Register')) {
                                    ...
                                    <div class="col-md-8 col-md-offset-2" style="margin-top: 40px;">
                                          <form method="post" action="registerUser.php" role="form" data-toggle="validator">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <input type="number" class="form-control" id="inputTelephone" placeholder="43749409" name="telephone" required>
                                                </div>
                                                 <div class="form-group">
                                                    <label for="address" class="control-label">Address</label>
                                                    <input type="text" class="form-control" id="inputAddres" placeholder="cra 65b # 45 - 38" name="address" required>
                                                </div>
                                                 <div class="form-group">
                                    ...
                                    <?php } else {   
                                                if(insertUser($_POST['email'],$_POST['name'],$_POST['telephone'],$_POST['address'],$_POST['country'])){
                                    ...
                                    ?>
                                           <div class="col-md-8 col-md-offset-2" style="margin-top: 40px;">
                                               <h4>The mail is alredy conected with another user</h4>
                                          </div>      
                                    <?php
                                                }
                                          }?>
...
<?php 
      ...
      function insertUser($email,$name,$tel,$add,$country){
            ...
            $document = $userCollection->findone(
                        ['email'=>$email]
            );

            if(is_null($document)){
                  $insertOneResult = $userCollection->insertOne(
                        ['name' => $name,'email' =>$email, 'telephone' =>$tel, 'address' =>$add, 'country'=>$country] 
                  );
                  return true;
            }else{
                  return false;
