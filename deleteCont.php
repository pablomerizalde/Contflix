    ...
    <div class="col-md-10 col-md-offset-1" style="margin-top: -20px;">
      ...
      <div class="jumbotron">
        ...
        <ul class="nav nav-tabs">
          ...
          <li role="presentation" class="active"><a href="deleteCont.php">Delete</a></li>  
        </ul>
                               ...
                               <?php   if (!isset ($_POST['idUser']) ||($_POST['idUser'] != 'IDUSER')) {
                                 ?>
                                         <div class="col-md-4 col-md-offset-2" style="margin-top: 40px;">
                                          <form method="post" action="deleteCont.php" role="form" data-toggle="validator">
                                ...
                                <?php
                                     ...
                                     if(  deleteCont($_POST['idUs'])  ){ 
                                        ?> 
                                        <div class="col-md-6 col-md-offset-2" style="margin-top: 40px;">
                                        <h3>Content deleted correctly</h3>
                                        </div>
                                        <?php
                                       }else{
                                    ?>  
                                    <div class="col-md-6 col-md-offset-2" style="margin-top: 40px;">
                                      <div class="alert alert-danger" role="alert">Content not foud, try with another id</div>
                                      <form action="deleteCont.php">
