                                ...
                                require 'vendor/autoload.php';
                                  ...
                                  if (!isset ($_POST['register']) ||($_POST['register'] != 'Register')) {
                                    ...
                                    <div class="col-md-8 col-md-offset-2" style="margin-top: 40px;">
                                          <form method="post" action="updateCont2.php" role="form" data-toggle="validator">
                                                <div class="form-group">
                                                                            <label for="name" class="control-label">Name</label>
                                                                            <input type="text" class="form-control" id="inputName" value= "<?php echo $usu->name; ?>" name="name" required>
                                                                          </div>
                                                <div class="form-group">
                                                                            <label for="telephone" class="control-label">Premier</label>
                                                                            <input type="date" class="form-control" id="inputTelephone" value= <?php echo $usu->date; ?> name="date" required>
                                                </div>
                                                <div class="form-group">
                                    ...
                                    <?php } else {   
                                          updateCont($_POST['name'],$_POST['date'],$_POST['country']);

                                    ?>
                                    <div class="col-md-8 col-md-offset-2" style="margin-top: 40px;">
                                          Name: <?php echo $_POST['name']; ?> <br>
                                          Premier: <?php echo $_POST['date']; ?> <br>
...
<?php 
      ...
      function updateCont($name,$date,$country){
            $id = $_SESSION['idCont'];
            ...
            require 'vendor/autoload.php';
                ...
                $replaceResult = $contCollection->updateOne(
                      ['_id' =>  $MongoId],
                      ['$set'=>['name' => $name,'date'=>$date,'country'=>$country]]
            );
