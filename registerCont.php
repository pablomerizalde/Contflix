        ...
        <div class="col-md-10 col-md-offset-1" style="margin-top: -20px;">
            ...
            <div class="jumbotron">
                ...
                <ul class="nav nav-tabs">
                    ...
                    <li role="presentation" class="active"><a href="registerCont.php">Create</a></li>
                        ...
                        <div class="row">
                              ...
                              <?php 
                                   if (!isset ($_POST['register']) ||($_POST['register'] != 'Register')) {
                                    ...
                                    <?php } else {   
                                                if(insertCont($_POST['name'],$_POST['date'],$_POST['country'])){
                                    ...
                                    ?>
                                           <div class="col-md-8 col-md-offset-2" style="margin-top: 40px;">
                                               <h4>The content is alredy created</h4>
                                          </div>      
                                    <?php
                                                }
                                          }?>
...
<?php 
      ...
      function insertCont($name,$date,$country){
            ...
            if(is_null($document)){
                  $insertOneResult = $contCollection->insertOne(
                        ['name' => $name,'date'=>$date, 'country'=>$country] 
                  );
                  return true;
            }else{
                  return false;
